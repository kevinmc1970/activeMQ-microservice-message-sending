...
public class MessagetestingApplication {
	...
	public static void main(String[] args) {
		...
		// simple testing of JMS here
		JmsTemplate jmsTemplate = ctx.getBean(JmsTemplate.class);
		
		// spring will convert second param to JMS message i.e. TextMessage or convert a hasmap into a MapMessage
		...
		// when running this springboot app the the 'this is a test' message will appear in the queue 
